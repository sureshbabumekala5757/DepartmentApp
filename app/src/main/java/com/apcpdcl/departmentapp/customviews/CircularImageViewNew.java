...
public class CircularImageViewNew extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public CircularImageViewNew(final Context context) {
        this(context, null);
    }

    public CircularImageViewNew(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircularImageViewNew(Context context, AttributeSet attrs, int defStyleAttr) {
