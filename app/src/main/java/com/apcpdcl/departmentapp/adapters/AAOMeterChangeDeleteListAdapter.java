...
import com.apcpdcl.departmentapp.activities.AAODeleteMeterChangeActivity;
import com.apcpdcl.departmentapp.activities.AAOMeterChangeDeleteListActivity;
...
public class AAOMeterChangeDeleteListAdapter extends BaseAdapter implements Filterable {
    private ArrayList<MeterChangeListModel> sortedList;
    private ArrayList<MeterChangeListModel> mList;
    private final LayoutInflater inflater;
    private AAOMeterChangeDeleteListActivity meterChangeListActivity;
    private String mFrom;

    public AAOMeterChangeDeleteListAdapter(AAOMeterChangeDeleteListActivity meterChangeListActivity,
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            viewHolder.tv_delete_reason = (TextView) view.findViewById(R.id.tv_delete_reason);
            viewHolder.tv_delete_date = (TextView) view.findViewById(R.id.tv_delete_date);
        ...
        viewHolder.tv_delete_reason.setText("Meter Change Delete Initiated by AE");
        viewHolder.tv_delete_date.setText("");
        ...
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(meterChangeListActivity, AAODeleteMeterChangeActivity.class);
