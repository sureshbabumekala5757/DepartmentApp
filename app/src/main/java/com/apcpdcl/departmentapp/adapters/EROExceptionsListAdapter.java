...
public class EROExceptionsListAdapter extends BaseAdapter {
    ...
    public EROExceptionsListAdapter(Activity context, ArrayList<ExceptionReportModel> registrationModels, boolean show) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (mShow){
            ...
            viewHolder.tv_name.setText(exceptionReportModel.getERO_Name());
            ...
            viewHolder.tv_name_t.setText(exceptionReportModel.getERO_Name());
