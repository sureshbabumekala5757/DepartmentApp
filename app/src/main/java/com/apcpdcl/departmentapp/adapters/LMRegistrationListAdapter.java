...
public class LMRegistrationListAdapter extends BaseAdapter implements Filterable {
    private ArrayList<RegistrationModel> sortedList;
    private ArrayList<RegistrationModel> mList;
    private final LayoutInflater inflater;
    private LMRegistrationListActivity registrationListActivity;


    public LMRegistrationListAdapter(LMRegistrationListActivity context, ArrayList<RegistrationModel> registrationModels) {
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                mList = (ArrayList<RegistrationModel>) results.values;
