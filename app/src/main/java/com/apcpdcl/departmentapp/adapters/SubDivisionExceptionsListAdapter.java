...
public class SubDivisionExceptionsListAdapter extends BaseAdapter {
    private ArrayList<ExceptionReportModel> mList;
    private final LayoutInflater inflater;
    private Activity context;
    private boolean mShow;

    public SubDivisionExceptionsListAdapter(Activity context, ArrayList<ExceptionReportModel> registrationModels, boolean show) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (mShow){
            ...
            viewHolder.tv_name.setText(exceptionReportModel.getDIV_Name());
            ...
            viewHolder.tv_name_t.setText(exceptionReportModel.getDIV_Name());
