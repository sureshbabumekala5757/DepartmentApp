...
public class InterruptionsListAdapter extends BaseAdapter {
    private ArrayList<InterruptionsListModel> mList;
    private final LayoutInflater inflater;

    public InterruptionsListAdapter(Activity context, ArrayList<InterruptionsListModel> registrationModels) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        final InterruptionsListModel outagesModel = mList.get(i);
        ...
        viewHolder.tv_outage.setText(outagesModel.getFromTime());
        viewHolder.tv_restore.setText(outagesModel.getToTime());
        viewHolder.tv_duration.setText(outagesModel.getDuration());
        viewHolder.tv_reason.setText(outagesModel.getReasonName());
