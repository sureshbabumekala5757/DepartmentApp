...
import com.apcpdcl.departmentapp.activities.MatsDailyReports;
...
public class MatsReportsDataBaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "matsReportsDB";

    private static final String TABLE_REPORTSLIST = "MatsReportsList";
    ...
    public MatsReportsDataBaseHandler(Context context) {
    ...
    public List<ReportsList> getAllreportslists() {
        ...
        // Select All Query
        String selectQuery = "SELECT * FROM" + " " + TABLE_REPORTSLIST + " " + "WHERE" + " " + "SUBSTR" + "(" + KEY_DATE + ",4,3)" + " " + "=" + " " + "'" + MatsDailyReports.month_string + "'";
    ...
    public int getDeleteCount() {
        String selectQuery = "DELETE FROM" + " " + TABLE_REPORTSLIST + " " + "WHERE" + " " + "SUBSTR" + "(" + KEY_DATE + ",4,3)" + " " + "<>" + " " + "'" + MatsDailyReports.month_string + "'";
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);
