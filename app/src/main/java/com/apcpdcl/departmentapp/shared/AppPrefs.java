package com.apcpdcl.departmentapp.shared;
...
/**
 * Created by IT Wing on 07/03/2023.
 */
public class AppPrefs {
    ...
    public static AppPrefs getInstance(Context context) {
        if (instance == null) {
            if (context == null) {
                throw new IllegalStateException(AppPrefs.class.getSimpleName() +
    ...
    private AppPrefs(Context context) {
        mPreferences = context.getSharedPreferences(context.getPackageName() + "_preferences", Context.MODE_PRIVATE); // From Android sources for getDefaultSharedPreferences
    }
