...
import com.apcpdcl.departmentapp.adapters.InterruptionsListAdapter;
import com.apcpdcl.departmentapp.models.InterruptionsListModel;
...
public class InterruptionsListActivity extends AppCompatActivity {
    ...
    Button btn_submit;
    private ArrayList<InterruptionsListModel> outagesModelArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interrupations_list);
    ...
    private void init() {
        ...
        pDialog = new ProgressDialog(InterruptionsListActivity.this);
    ...
    private void getInterruptionsData() {
        ...
        try {
           // requestParams.put("sectionId", sectionCode);
            requestParams.put("fromTime", et_date.getText().toString());
            requestParams.put("toTime", et_restore_date.getText().toString());
            requestParams.put("sectionId", sectionCode);
            Utility.showLog("JSON", requestParams.toString());
            try {
                entity = new StringEntity(requestParams.toString());
                client.post(this, Constants.GET_INTERRUPTIONS_LIST, entity, "application/json", new AsyncHttpResponseHandler() {@Override
                            ...
                            if (jsonObject.has("STATUS") && jsonObject.optString("STATUS").equalsIgnoreCase("TRUE")) {
                                if (jsonObject.has("RESPONSE")) {
                                    ...
                                    for (int i = 0; i < jsonArray.length(); i++) {
                                        ...
                                        InterruptionsListModel interruptionModel = new Gson().fromJson(json.toString(),
                                                InterruptionsListModel.class);
                                ...
                                Utility.showCustomOKOnlyDialog(InterruptionsListActivity.this, jsonObject.optString("ERROR"));
                            }
                    ...
                    public void onFailure(int statusCode, Throwable error, String content) {
                        ...
                        Utility.showCustomOKOnlyDialog(InterruptionsListActivity.this, error.getMessage());
                    }
                });
    ...
    private void setListData() {
        if (outagesModelArrayList.size() > 0) {
            InterruptionsListAdapter outagesListAdapter = new InterruptionsListAdapter(this, outagesModelArrayList);
