...
import com.apcpdcl.departmentapp.adapters.MeterChangeReqListAdapter;
...
public class MeterChangeReqListActivity extends AppCompatActivity implements IUpdateList {
    ...
    private ArrayList<MeterChangeReqModel> meterChangeReqModels;
    private MeterChangeReqListAdapter meterChangeReqListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meter_change_req_list);
    ...
    /*Initialize Views*/
    private void init() {
        toolbar_title.setText(Utility.getResourcesString(this,R.string.meter_req_list));
        iUpdateList = this;
...
//        userID = prefs.getString("USERID", "");
        ...
        pDialog = new ProgressDialog(MeterChangeReqListActivity.this);
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            // in onActivityResult().
                            status.startResolutionForResult(MeterChangeReqListActivity.this, GPSTrackerActivity.REQUEST_CHECK_SETTINGS);
...
//                                    ServiceDetailsModel.class);
                            ...
                            Intent intent = new Intent(MeterChangeReqListActivity.this, NewConnectionReleaseActivity.class);
...
//                        }
                        ...
                        Utility.showCustomOKOnlyDialog(MeterChangeReqListActivity.this,
                ...
                public void onFailure(int statusCode, Throwable error, String content) {
                    ...
                    Utility.showCustomOKOnlyDialog(MeterChangeReqListActivity.this, "Something went wrong please try again later...");
                }
            });
        }catch (Exception e){
                    ...
                    try {
                        ...
                        if(jsonObject.getString("success").equalsIgnoreCase("true")) {
                            if (jsonObject.has("data")) {
                                ...
                                meterChangeReqModels = new ArrayList<>();
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    JSONObject json = jsonArray.optJSONObject(i);
//
                                    meterChangeReqModels.add(new MeterChangeReqModel(json.getString("uscno"),json.getString("servicerequest")));
                                    //Log.w("#AV", registrationModel.getRegno().toString());
                                }

                                if (meterChangeReqModels.size() > 0) {
                                    setListData();
                                } else {
                                    if (pDialog != null && pDialog.isShowing()) {
                                        pDialog.dismiss();
                ...
                public void onFailure(int statusCode, Throwable error, String content) {
                    ...
                    Utility.showCustomOKOnlyDialog(MeterChangeReqListActivity.this, "Currently Server is down, Please try again.");
                }
            });
        }catch (Exception e){
    ...
    private void setListData() {
        meterChangeReqListAdapter = new MeterChangeReqListAdapter(this, meterChangeReqModels);
        lv_reg.setAdapter(meterChangeReqListAdapter);
        implementsSearch();
        if (pDialog != null && pDialog.isShowing()) {
            pDialog.dismiss();
        }
    ...
    private void implementsSearch() {
        et_search.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (meterChangeReqListAdapter != null)
                    meterChangeReqListAdapter.getFilter().filter(s.toString());
            }
    ...
    public void updateList(String id) {
        for (int i = 0; i < meterChangeReqModels.size(); i++) {
            if (id.equalsIgnoreCase(meterChangeReqModels.get(i).getServiceRequest())) {
                meterChangeReqModels.remove(i);
                if (meterChangeReqModels.size() > 0) {
                    meterChangeReqListAdapter.notifyDataSetChanged();
                } else {
                    tv_no_data.setVisibility(View.VISIBLE);
                    lv_reg.setVisibility(View.GONE);
                }
