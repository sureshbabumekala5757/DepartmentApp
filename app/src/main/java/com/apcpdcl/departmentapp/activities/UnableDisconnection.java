...
public class UnableDisconnection extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private LinearLayout ll_fetch_location, ll_map;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rdb = new ReportsDataBaseHandler(UnableDisconnection.this);
        pDialog = new ProgressDialog(UnableDisconnection.this);
       ...
       /* if (Utility.isNetworkAvailable(this)) {
        ...
        list.add("Select");
        list.add("Payment already Done");
        list.add("Court Case");
        list.add("ERO Correspondence");
        list.add("Meter Testing");
        list.add("Abnormal Reading");
        list.add("Government Service");

        ArrayAdapter<String> reasonAdapter = new ArrayAdapter<String>(UnableDisconnection.this, android.R.layout.simple_spinner_item, list);
        ...
        home_imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(UnableDisconnection.this, Home.class);
            ...
            public void onClick(View view) {
                try {
                    ...
                    if (strReason.equals("Select")) {
                        Toast.makeText(getApplicationContext(), "Please Select One Reason", Toast.LENGTH_LONG).show();
                        return;
                    } else {
                        ...
                        try{
                            requestObj.put("bp_no",strServiceNumber);
                            requestObj.put("reason",strReason);
    ...
    public void checkConnectivity(JSONObject requestObj) {
...
//                params.put("DATA", totalString);
                invokeUnableDisconnectionWebService(requestObj);
//            } else {
...
//            }
    ...
    public void invokeUnableDisconnectionWebService(JSONObject requestObj) {
        pDialog.show();
        ...
        try {
            ...
            client.post(getApplicationContext(), ServiceConstants.USER_DC_UNABLETODISCONNECT, headers, entity, "application/json", new AsyncHttpResponseHandler() {
            @Override
...
//                    responseObj = responseObj.getJSONObject("ETY_UNABLE_TO_DISCONNECT");
                    ...
                    switch (status) {
                        case "True":
                            ...
                            startActivity(i);*/
                            DatabaseHandler db = new DatabaseHandler(UnableDisconnection.this);
            ...
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
                ...
                alertBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ActivityCompat.requestPermissions(UnableDisconnection.this, new String[]{Manifest.permission.READ_PHONE_STATE}, REQUEST_CODE_PHONE_STATE_READ);
        ...
        if (!Utility.isValueNullOrEmpty(mLat) && !mLat.equalsIgnoreCase("0")) {
            ...
            mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
                ...
                public boolean onMarkerClick(Marker marker) {
                    Intent intent = new Intent(UnableDisconnection.this, ExploreLocalityActivity.class);
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(UnableDisconnection.this, REQUEST_CHECK_SETTINGS);
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (mLastLocation != null) {
            ...
            if (!Geocoder.isPresent()) {
                Utility.showToastMessage(this, Utility.getResourcesString(UnableDisconnection.this, R.string.no_geocoder_available));
            } else {
                tv_lat.setText(String.format("%s", mLastLocation.getLatitude()));
                tv_long.setText(String.format("%s", mLastLocation.getLongitude()));
                mMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.drawable.marker_pin))
