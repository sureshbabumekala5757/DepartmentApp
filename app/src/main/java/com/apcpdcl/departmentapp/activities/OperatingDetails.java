...
public class OperatingDetails extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    String strServiceNumber, strMeterNum, strkwh, strkvah, strremarks, sec_code, totalString, strDiscDate, strDate, strLoc, sDType, strDeviceId, lmcode;
    ...
    NetworkFailureDcListDatabaseHandler ndb = new NetworkFailureDcListDatabaseHandler(this);
...
//        lmcode = prefs.getString("LMCode", "");
        ...
        pDialog = new ProgressDialog(OperatingDetails.this);
        rdb = new ReportsDataBaseHandler(OperatingDetails.this);
        ...
        if (bd != null) {
            ...
            strMeterNum = (String) bd.get("MeterNum");
            et_meternumber.setText(strMeterNum);
        ...
        home_imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(OperatingDetails.this, Home.class);
        ...
        ArrayAdapter<String> dTypeAdapter = new ArrayAdapter<String>(OperatingDetails.this, android.R.layout.simple_spinner_item, list);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    strMeterNum = et_meternumber.getText().toString();
...
//                        if (IsNullOrBlank(strMeterNum)) {
//                            Toast.makeText(getApplicationContext(), "Please Enter Meter Number", Toast.LENGTH_LONG).show();
//                        } else {
...
//                        else if (IsNullOrBlank(strMeterNum)) {
//                            Toast.makeText(getApplicationContext(), "Please Enter Meter Number", Toast.LENGTH_LONG).show();
//                        }
                        else {
                            if (IsNullOrBlank(strLoc)) {
                    ...
                    try{
                        requestObj.put("bp_number",strServiceNumber);
                        requestObj.put("kwh",strkwh);
                        requestObj.put("kvah",strkvah);
                        checkConnectivity(requestObj);
                    }catch (Exception e){
                        e.printStackTrace();
                    }
                } catch (Exception e) {
    ...
    public void checkConnectivity(JSONObject requestObjVal) {
...
//                params.put("DATA", totalString);
                invokeDetaillSaveWebService(requestObjVal);
//            }
        } else {
            totalString = totalString + "|0|0";
    ...
    public void invokeDetaillSaveWebService(JSONObject requestObj) {
        pDialog.show();
        ...
        try {
            ...
            BasicHeader[] headers = new BasicHeader[]{new BasicHeader("Authorization", "Basic "+AppPrefs.getInstance(getApplicationContext().getApplicationContext()).getString("USER_AUTH", ""))};
            Utility.showLog("URL", Constants.URL + Constants.GEO_LATLONGINPUT);
            client.post(getApplicationContext(), ServiceConstants.USER_DC_DISCONNECTION, headers, entity, "application/json", new AsyncHttpResponseHandler() {
            @Override
                    ...
                    switch (status) {
                        case "True":
                           ...
                           /* Intent i = new Intent(OperatingDetails.this, Operating.class);
                            startActivity(i);*/
                            DatabaseHandler db = new DatabaseHandler(OperatingDetails.this);
                            db.updateDCList(strServiceNumber, "0","0");
                            finish();
                            break;
                        case "False":
                            if (pDialog != null && pDialog.isShowing()) {
            ...
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
                ...
                alertBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ActivityCompat.requestPermissions(OperatingDetails.this, new String[]{Manifest.permission.READ_PHONE_STATE}, REQUEST_CODE_PHONE_STATE_READ);
        ...
        if (!Utility.isValueNullOrEmpty(mLat) && !mLat.equalsIgnoreCase("0")) {
            ...
            mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
                ...
                public boolean onMarkerClick(Marker marker) {
                    Intent intent = new Intent(OperatingDetails.this, ExploreLocalityActivity.class);
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(OperatingDetails.this, REQUEST_CHECK_SETTINGS);
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (mLastLocation != null) {
            ...
            if (!Geocoder.isPresent()) {
                Utility.showToastMessage(this, Utility.getResourcesString(OperatingDetails.this, R.string.no_geocoder_available));
            } else {
                tv_lat.setText(String.format("%s", mLastLocation.getLatitude()));
                tv_long.setText(String.format("%s", mLastLocation.getLongitude()));
                mMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.drawable.marker_pin))
