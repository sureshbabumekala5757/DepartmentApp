...
public class AAODashBoardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aao_dashboard_activity);
    ...
    private void init() {
        ...
        if(userType.equalsIgnoreCase("JAO") || userType.equalsIgnoreCase("SA") || userType.equalsIgnoreCase("JA")){
            ll_billing.setVisibility(View.GONE);
            first_ll.setGravity(Gravity.CENTER);
        }
        Toolbar mToolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setDisplayShowTitleEnabled(false);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        pDialog = new ProgressDialog(AAODashBoardActivity.this);
                ...
                try {
                    ...
                    switch (status) {
                        ...
                        case "FALSE":
                            ...
                            if (Utility.isNetworkAvailable(AAODashBoardActivity.this)) {
                                ...
                                request.setDestinationInExternalFilesDir(AAODashBoardActivity.this, Environment.DIRECTORY_DOWNLOADS, "Apcpdcl_DepartmentApp_" + LVersion + ".apk");
    ...
    @OnClick({R.id.ll_collections, R.id.iv_collections, R.id.tv_collections})
    void navigateToCollections() {
        Intent intent = new Intent(this, CollectionsDashBoardActivity.class);
    ...
    @OnClick({R.id.ll_billing, R.id.iv_billing, R.id.tv_billing})
    void navigateToBillingDashBoard() {
        Intent intent = new Intent(this, BillingDashBoardActivity.class);
        startActivity(intent);
    }

    @OnClick({R.id.ll_dc_operations, R.id.iv_dc_operations, R.id.tv_dc_operations})
    void navigateToDCListTransactions() {
        Intent in = new Intent(getApplicationContext(), AAODcListTrackingActivity.class);
        startActivity(in);
    }
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            // in onActivityResult().
                            status.startResolutionForResult(AAODashBoardActivity.this, GPSTrackerActivity.REQUEST_CHECK_SETTINGS);
    ...
    private BroadcastReceiver downLoadReciever = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Utility.clearDatabase(AAODashBoardActivity.this);
