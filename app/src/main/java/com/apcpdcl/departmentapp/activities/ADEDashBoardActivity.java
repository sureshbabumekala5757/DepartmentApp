...
public class ADEDashBoardActivity extends AppCompatActivity {
    ...
    @BindView(R.id.ll_dtr_photosupload)
    LinearLayout ll_dtr_photosupload;
    @BindView(R.id.iv_dtr_photosupload)
    ImageView iv_dtr_photosupload;
    @BindView(R.id.tv_dtr_photosupload)
    TextView tv_dtr_photosupload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ade_dashboard_activity);
                ...
                try {
                    ...
                    switch (status) {
                        ...
                        case "FALSE":
                            ...
                            if (Utility.isNetworkAvailable(ADEDashBoardActivity.this)) {
                                Uri download_Uri = Uri.parse(Constants.DOWNLOAD_PATH + LVersion + ".apk");
                                pDialog = new ProgressDialog(ADEDashBoardActivity.this);
                                ...
                                request.setDestinationInExternalFilesDir(ADEDashBoardActivity.this, Environment.DIRECTORY_DOWNLOADS, "Apcpdcl_DepartmentApp_" + LVersion + ".apk");
    ...
    void navigateToCheckReading() {
        ...
        in.putExtra(Constants.FROM, ADEDashBoardActivity.class.getSimpleName());
        startActivity(in);
    }
    ...
    void navigateToDCListTransactions() {
        Intent in = new Intent(getApplicationContext(), ADEDcListTrackingActivity.class);
    ...
    @OnClick({R.id.ll_dtr_photosupload, R.id.iv_dtr_photosupload, R.id.tv_dtr_photosupload})
    void navigateToDtrTrackingPhotosUpload() {
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            // in onActivityResult().
                            status.startResolutionForResult(ADEDashBoardActivity.this, GPSTrackerActivity.REQUEST_CHECK_SETTINGS);
    ...
    private BroadcastReceiver downLoadReciever = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Utility.clearDatabase(ADEDashBoardActivity.this);
