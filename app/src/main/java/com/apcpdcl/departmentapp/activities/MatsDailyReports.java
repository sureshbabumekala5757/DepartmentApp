...
public class MatsDailyReports extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rdb = new MatsReportsDataBaseHandler(MatsDailyReports.this);
    ...
    public void onResume() {
        ...
        home_imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(MatsDailyReports.this,Home.class);
    ...
    public class MyReportsAsyncTasks extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(MatsDailyReports.this);
        ...
        protected void onPostExecute(String s) {
            if (reportsList.size() > 0) {
                ...
                reportListAdapter = new ReportListAdapter(MatsDailyReports.this, reportsList);
