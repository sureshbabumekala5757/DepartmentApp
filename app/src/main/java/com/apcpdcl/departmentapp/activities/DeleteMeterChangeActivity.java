...
public class DeleteMeterChangeActivity extends AppCompatActivity {
    ...
    private void getMeterDetails() {
        ...
        client.post(Constants.METER_CHANGE_URL + Constants.MODIFY_MTR_DETAILS, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    if (jsonObject.has("MSG")) {
                        Utility.showCustomOKOnlyDialog(DeleteMeterChangeActivity.this, "Not a valid Service Number");
                    } else {
            ...
            public void onFailure(int statusCode, Throwable error, String content) {
                ...
                switch (statusCode) {
                    case 404:
                        Utility.showCustomOKOnlyDialog(DeleteMeterChangeActivity.this, "Unable to Connect Server");
                        break;
                    case 500:
                        Utility.showCustomOKOnlyDialog(DeleteMeterChangeActivity.this, "Something went wrong at server end");
                        break;
                    default:
                        Utility.showCustomOKOnlyDialog(DeleteMeterChangeActivity.this, "Check Your Internet Connection and Try Again");
    ...
    private void deleteMeterDetails() {
        ...
        AsyncHttpClient client = new AsyncHttpClient();
        Utility.showLog("URL", Constants.METER_CHANGE_URL + Constants.DELETE_MTR_DETAILS);
        Utility.showLog(Constants.USCNO, mServiceNum);
        Utility.showLog(Constants.MTRCHGDT, mMeterChgDate);
        Utility.showLog(Constants.NEWMTRNO, mNewMtrNum);
        // client.addHeader("SCNO", scno);
        client.post(Constants.METER_CHANGE_URL + Constants.DELETE_MTR_DETAILS, params, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    if (jsonObject.has("RQSTATUS")) {
                        if (jsonObject.optString("RQSTATUS").equalsIgnoreCase("VALID")) {
                            ...
                            Utility.showToastMessage(DeleteMeterChangeActivity.this, jsonObject.optString("MSG"));
                            finish();
                        } else if (jsonObject.has("MSG")) {
                            Utility.showCustomOKOnlyDialog(DeleteMeterChangeActivity.this,
