...
import com.apcpdcl.departmentapp.adapters.AAOMeterChangeDeleteListAdapter;
...
public class AAOMeterChangeDeleteListActivity extends AppCompatActivity implements IUpdateList {
    ...
    private AAOMeterChangeDeleteListAdapter meterChangeListAdapter;
    ...
    /* Initialize Views*/
    private void init() {
        toolbar_title.setText(Utility.getResourcesString(this, R.string.delete_list));
        ...
        pDialog = new ProgressDialog(AAOMeterChangeDeleteListActivity.this);
    ...
    private void setListData() {
        meterChangeListAdapter = new AAOMeterChangeDeleteListAdapter(this, meterChangeListModels, mFrom);
    ...
    private void getMeterChangeList() {
        ...
        client.post(Constants.URL_ERO + "delete_scno", params, new AsyncHttpResponseHandler() {
            @Override
        ...
        spn_section.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            public void onItemSelected(AdapterView<?> parent, View arg1, int position, long arg3) {
                if (position != 0) {
                    ...
                    if (Utility.isNetworkAvailable(AAOMeterChangeDeleteListActivity.this)) {
                        pDialog.show();
                        getMeterChangeList();
                    } else {
                        Utility.showCustomOKOnlyDialog(AAOMeterChangeDeleteListActivity.this,
                                Utility.getResourcesString(AAOMeterChangeDeleteListActivity.this,
                                        R.string.no_internet));
                    }
                } else {
                    sectionCode = "";
            ...
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    if (jsonObject.has("RQSTATUS")) {
                        Utility.showCustomOKOnlyDialog(AAOMeterChangeDeleteListActivity.this, jsonObject.optString("MSG"));
