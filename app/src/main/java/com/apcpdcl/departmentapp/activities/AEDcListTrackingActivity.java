...
public class AEDcListTrackingActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        if (Utility.isNetworkAvailable(this)) {
            ...
            pDialog.setCancelable(false);
            getLMDCAbstract(Constants.AE_COUNT_SLAB, false);
        } else {
                    ...
                    if (jsonArray.length() > 0) {
                        ...
                        if (isNS) {
                            ...
                            ViewPagerAdapter adapter = new ViewPagerAdapter(getSupportFragmentManager(),
                                    tl_type.getTabCount(), lmDcListModelsSlab, lmDcListModelsNonSlab, AEDcListTrackingActivity.class.getSimpleName());
                            ...
                            getLMDCAbstract(Constants.AE_COUNT_NON_SLAB, true);
                        }
                    }else  if (isNS) {
                        if (pDialog != null && pDialog.isShowing()) {
                            pDialog.dismiss();
